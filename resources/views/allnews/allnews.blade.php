            ...
            <div class="col-lg-7 col-12">
                {{-- <div class="news-block">
                    ...
                    <div class="news-block-info">
                        ...
                        <div class="news-block-title mb-2">
                            <h4><a href="{{ url('post2') }}" class="news-block-title-link">
                                    Dolomite Powder</a></h4>
                        </div>

                        <div class="news-block-body">
                            <p><strong>Dolomite Powder</strong>
                                is a type of taro originating from the city of Bogor, West Java, Indonesia. It
                                thrives in the Bogor area where the climate and soil are suitable for its growth.</p>
                        </div>
                    </div>
                </div> --}}
                ...
                <div class="news-block mt-3">
                    ...
                    <div class="news-block-info">
                        ...
                        <div class="news-block-title mb-2">
                            <h4><a href="{{ url('post3') }}" class="news-block-title-link">From Local to Global</a>
                            </h4>
                        </div>

                        <div class="news-block-body">
                            <p>From Local to Global: The Success Story of PT Maju Lokal Nusantara in
                                Developing Business and Selling Seafood Products Internationally,
                                <a href="{{ url('post3') }}" target="_blank">klil me</a> for more information.
                            </p>
                        </div>
                    </div>
                </div>
