        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav">
                        <a class="nav-link smoothscroll" href="/#section_1">Home</a>
                    </li>

                    <li class="nav">
                        <a class="nav-link smoothscroll" href="/#section_2">About</a>
                    </li>

                    <li class="nav">
                        <a class="nav-link smoothscroll" href="/#section_3">Products</a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link smoothscroll dropdown-toggle" href="/#section_4"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        <p class="copyright-text mb-0">Copyright © 2023 <a href="#">PT. Maju Lokal
                                Nusantara</a>
                        </p>
                    </div>
