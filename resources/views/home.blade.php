                    ...
                    <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('assets/images/slide/gotoGlobal.png') }}" class="carousel-image img-fluid"
                                    alt="...">

                                <div class="carousel-caption d-flex flex-column justify-content-end">
                                    <h1>UMKM Indonesia</h1>

                                    <p>Supporting small business to grow up</p>
                                </div>
                            </div>

                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/slide/images2.jpg') }}" class="carousel-image img-fluid"
                                    alt="...">

                                <div class="carousel-caption d-flex flex-column justify-content-end">
                                    <h1>From us to all</h1>

                                    <p>Introduce superior products</p>
                                </div>
                            </div>

                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/slide/images3.jpg') }}" class="carousel-image img-fluid"
                                    alt="...">

                                <div class="carousel-caption d-flex flex-column justify-content-end">
                                    <h1>Sell</h1>

                                    <p>Provide the best quality products</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-12">
                    <div class="custom-text-box">
                        ...
                        <p class="mb-0">Many products in Indonesia are not yet known or not yet recognised in
                            the
                            world.
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="custom-text-box d-flex flex-wrap d-lg-block mb-lg-0">
                                ...
                                <p class="mb-0">Our company is an export partner that provides transparent and
                                    sustainable export
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="custom-text-box mb-lg-0">
                                ...
                                <p class="mb-0">Providing quality product services that can compete in the
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="carousel-caption">
                                        ...
                                        <small class="carousel-name"><span class="carousel-name-title">Ministry of
                                                Investment
                                                /
                                ...
                                <div class="carousel-item">
                                    <div class="carousel-caption">
                                        ...
                                        <small class="carousel-name"><span class="carousel-name-title">Directorate General
                                                of
                                                Taxation</span>
                                            (DJP)</small>
                                    </div>
                                ...
                                <div class="carousel-item">
                                    <div class="carousel-caption">
                                        <small class="carousel-name"><span class="carousel-name-title">Indonesia
                                                Export</span>
                                        </small>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="carousel-caption">
                                        <small class="carousel-name"><span class="carousel-name-title">Ministry of Marine
                                                Affairs and Fisheris Republic of Indonesia
                                            </span>
                                        </small>
                                    </div>
                                </div>
                                ...
                                <ol class="carousel-indicators">
                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="0" class="active">
                                        <img src="{{ asset('assets/images/avatar/oss.png') }}"
                                            class="rounded-circle avatar-image_2" alt="avatar">
                                    </li>

                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="1" class="">
                                        <img src="{{ asset('assets/images/avatar/djp.png') }}"
                                            class="rounded-circle avatar-image_2" alt="avatar">
                                    </li>
